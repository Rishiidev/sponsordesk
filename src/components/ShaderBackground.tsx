...
// "Waves" — animated WebGL mesh/flow background, made with the 21st.dev
// Shader Builder. Zero dependencies: one fullscreen-triangle WebGL1 canvas.
// Mount behind content with a position:relative wrapper + this absolutely
// positioned inside it. Cursor interaction is off for this preset.
...
// "Waves" preset — dusk palette (#1A1423 -> #B75D69 -> #EACDC2 -> #FFF5EB),
// OKLab-blended, cursor off.
const UNIFORMS = {
  colors: [
    [0.102, 0.078, 0.137],
    [0.718, 0.365, 0.412],
  ...
  brightness: 0.07,
  saturation: 2.0,
  hue: 2.27, // 130 degrees in radians
  vignette: 0.0,
  blur: 0.04,
  grain: 0.35,
  seed: 4984.0,
